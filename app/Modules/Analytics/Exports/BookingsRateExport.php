...
class BookingsRateExport extends BaseExport
{
    public function data(?int $take = null, ?int $skip = null)
    {
        ...
        $query = $bookingAnalyticsRepositoryInterface->bookingsRate(new Request($this->request), false, $this->requester->timezone);
